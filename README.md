...
![Introduction Preview](media/Introduction_preview.gif)
...
> **Digital Solutions Architect:** [Your Name Here]
...
> **Note for TWG:** The icon SVG file is included in this repository as `samal-ecotourism-icon.png`. It can be embedded directly into Word documents, PowerPoint presentations, and barangay bulletin boards without quality loss.
